...
function About() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative py-10 md:py-14 bg-[var(--color-surface)]/50 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-[var(--color-text-muted)] animate-slide-up" style={{ animationDelay: '100ms' }}>
              {t('subtitle')}
            </p>
          </div>
        </div>
