...
export const GAMES: Record<GameId, Game> = {
  shipofharkinian: {
    ...
    themeId: 'shipwright',
    gradient: 'from-emerald-700/30 to-amber-400/20',
  ...
  '2ship2harkinian': {
    ...
    themeId: '2ship',
    gradient: 'from-purple-700/30 to-amber-300/20',
  ...
  ghostship: {
    ...
    themeId: 'ghostship',
    gradient: 'from-blue-700/30 to-yellow-400/20',
  ...
  lighthouse: {
    ...
    themeId: 'lighthouse',
    gradient: 'from-sky-600/30 to-amber-400/20',
